                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    if(file_exists($imageURL) && $row["photo"] != ""): 
                                    ?>
                                        <a href="<?php echo $imageURL; ?>"><img src="<?php echo $imageURL; ?>" alt="Photo" /></a>
                                    <?php else: ?>
                                ...
                                <td>
                                    ...
                                    <p><small>Contact No: <b><?php echo $row['contact_no'] ?></b></small></p>
                                    <p><small>Email ID: <b><?php echo $row['email'] ?></b></small></p>
                                    <p><small>Aadhaar No: <b><?php echo $row['aadhaar'] ?></b></small></p>
                                    <p><small>PAN: <b><?php echo $row['pan'] ?></b></small></p>
